class ResponseMocks {
  ...
  static final responseSucessGetMultipleWinners = {
    "years": [
  ...
  static final responseSucessGetStudiosWithCount = {
    "studios": [
  ...
  static final responseSucessGetMaxMinIntervalForProducers = {
    "min": [
  ...
  static final responseSucessGetWinnersByYear = [
    {
      "id": 197,
      "year": 2018,
      "title": "Holmes & Watson",
  ...
  static final responseSucessGetWinnersByYearPagination = {
    "content": [
      {
        "id": 100,
        "year": 1998,
      ...
      },
      {
        ...
        "producers": ["Andrew Form", "Bradley Fuller", "Galen Walker", "Ian Bryce", "Michael Bay", "Scott Mednick"],
        "winner": false
      },
      {
        "id": 180,
